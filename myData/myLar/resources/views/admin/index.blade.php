...
<head>
    ...
    <meta name="keywords" content="后台测试框架">
    <meta name="description" content="后台测试框架">
...
<body class="fixed-sidebar full-height-layout gray-bg" style="overflow:hidden">
    <div id="wrapper">
                ...
                <ul class="nav" id="side-menu">
                    <li class="nav-header">
                        <div class="dropdown profile-element">
                            ...
                            <ul class="dropdown-menu animated fadeInRight m-t-xs">
                                <li><a class="J_menuItem" href="{{url('admin/editHead')}}">修改头像</a>
                                </li>
                                <li><a class="J_menuItem" href="profile.html">个人资料</a>
                                </li>
                                <li><a class="J_menuItem" href="contacts.html">联系我们</a>
                                </li>
                                <li><a class="J_menuItem" href="{{url('admin/email/mailbox')}}">信箱</a>
                                </li>
                                <li class="divider"></li>
                                <li><a href="{{asset('admin/login')}}">安全退出</a>
                                </li>
                            </ul>
                        </div>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li>
                                <a class="J_menuItem" href="index_v2.html">文章管理</a>
                            </li>
                            <li>
                                <a class="J_menuItem" href="index_v3.html">回收站</a>
                            </li>
                            <li>
                    ...
                    <li>
                        <a href="{{url('admin/email/mailbox')}}"><i class="fa fa-envelope"></i> <span class="nav-label">信箱 </span><span class="label label-warning pull-right">16</span></a>
                        <ul class="nav nav-second-level">
                            <li><a class="J_menuItem" href="{{url('admin/email/mailbox')}}">收件箱</a>
                            </li>
                            <li><a class="J_menuItem" href="{{url('admin/email/mail_detail')}}">查看邮件</a>
                            </li>
                            <li><a class="J_menuItem" href="{{url('admin/email/mail_compose')}}">写信</a>
                            </li>
                        </ul>
                    </li>
                </ul>
        ...
        <div id="page-wrapper" class="gray-bg dashbard-1">
            ...
            <div class="row content-tabs">
                ...
                <a href="{{url('/')}}" class="roll-nav roll-right J_tabExit"><i class="fa fa fa-sign-out"></i> 退出</a>
            </div>
    ...
    <script type="text/javascript" src="{{asset('js/contabs.min.js')}}"></script>
