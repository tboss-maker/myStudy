        ...
        <div class="mail-box">
            ...
            <table class="table table-hover table-mail">
                ...
                <tr class="unread">
                    ...
                    <td class="mail-ontact"><a href="mail_detail.blade.php">支付宝</a>
                    </td>
                    <td class="mail-subject"><a href="mail_detail.blade.php">支付宝提醒</a>
                    </td>
                ...
                <tr class="unread">
                    ...
                    <td class="mail-ontact"><a href="mail_detail.blade.php">Amaze UI</a>
                    </td>
                    <td class="mail-subject"><a href="mail_detail.blade.php">Amaze UI Beta2 发布</a>
                    </td>
                    <td class=""></td>
                ...
                <tr class="read">
                    ...
                    <td class="mail-ontact"><a href="mail_detail.blade.php">WordPress</a> <span
                                class="label label-warning pull-right">验证邮件</span>
                    </td>
                    <td class="mail-subject"><a href="mail_detail.blade.php">wp-user-frontend-pro v2.1.9</a>
                    </td>
                    <td class=""></td>
                ...
                <tr class="read">
                    ...
                    <td class="mail-ontact"><a href="mail_detail.blade.php">淘宝网</a>
                    </td>
                    <td class="mail-subject"><a href="mail_detail.blade.php">史上最全！淘宝双11红包疯抢攻略！</a>
                    </td>
                    <td class=""></td>
                ...
                <tr class="read">
                    ...
                    <td class="mail-ontact"><a href="mail_detail.blade.php">淘宝网</a> <span
                                class="label label-danger pull-right">AD</span>
                    </td>
                    <td class="mail-subject"><a href="mail_detail.blade.php">亲，双11来啦！帮你挑货，还送你4999元红包！仅此一次！</a>
                    </td>
                    <td class=""><i class="fa fa-paperclip"></i>
                    </td>
